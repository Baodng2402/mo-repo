...
import type { EvaluationSummary, EvaluationDetail, ContributionInput } from '@/services/evaluationService';
        ...
        return (
            <SafeAreaView className="flex-1 bg-[#101922]" edges={['top']}>
                    ...
                    {(isCreator || isLeader) && (
                        <View className="flex-row gap-2">
                            <TouchableOpacity
                                ...
                                className="w-9 h-9 items-center justify-center rounded-xl bg-[#1A2332]"
                            >
                ...
                >
                    ...
                    {/* Contributions */}
                    <Text className="text-gray-400 text-xs uppercase tracking-wider mb-3 mt-1">
                        Contribution Split
                    </Text>
                    {selectedEval.contributions
                        ...
                        .map((c) => (
                            <View key={c.user_id} className="bg-[#1A2332] rounded-2xl p-4 mb-3">
                                <View className="flex-row items-center justify-between">
                                    <View className="flex-row items-center flex-1">
                                        <View className="w-9 h-9 rounded-full bg-[#243447] items-center justify-center">
                                    ...
                                    <Text className="text-[#7C3AED] font-bold text-lg ml-2">
    ...
    return (
        <SafeAreaView className="flex-1 bg-[#101922]" edges={['top']}>
            ...
            <View className="flex-row items-center px-4 py-3">
                ...
                <View className="flex-1 ml-3">
                    <Text className="text-white text-lg font-bold">Evaluations</Text>
                    <Text className="text-gray-500 text-xs">{group?.name}</Text>
                </View>
                {isLeader && (
                    <TouchableOpacity
                        onPress={openCreateForm}
                        className="flex-row items-center gap-1.5 bg-[#7C3AED] px-3 py-2 rounded-xl"
                    >
            ...
            >
                {evaluations.length === 0 ? (
                    <View className="items-center justify-center mt-24 gap-3">
...
const EvalFormModal = ({
    ...
    return (
        <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
            ...
            >
                <View className="bg-[#101922] rounded-t-3xl" style={{ maxHeight: '92%' }}>
                    {/* Handle */}
                    <View className="items-center pt-3 pb-1">
                        <View className="w-10 h-1 rounded-full bg-[#243447]" />
                    </View>
                    ...
                    >
                        {/* Title */}
                        <Text className="text-gray-400 text-xs uppercase tracking-wider mt-4 mb-1.5">
                            Title *
                        </Text>
                        <TextInput
                            value={title}
                            ...
                            maxLength={200}
                            className="bg-[#1A2332] text-white px-4 py-3 rounded-xl text-sm"
                        />
                        ...
                        {/* Total Progress */}
                        <View className="bg-[#1A2332] rounded-2xl p-4 mt-4">
                        ...
                        {/* Member inputs */}
                        <Text className="text-gray-400 text-xs uppercase tracking-wider mt-4 mb-2">
                            Contributions (must total 100%)
                        </Text>
                        {contribs.map((c) => (
                            <View key={c.user_id} className="bg-[#1A2332] rounded-2xl p-3 mb-2">
                                <View className="flex-row items-center">
                                    ...
                                    <Text className="text-white text-sm font-medium flex-1 ml-3" numberOfLines={1}>
                                        {c.full_name}
                                    </Text>
                                    <View className="flex-row items-center">
                                        <TextInput
                                            ...
                                            placeholder="0"
                                            placeholderTextColor="#475569"
                                            className="bg-[#243447] text-white text-center font-bold text-base w-16 h-10 rounded-xl"
                                        />
                                        <Text className="text-gray-400 text-base font-bold ml-1">%</Text>
                                    </View>
                                </View>
                            </View>
                        ))}
